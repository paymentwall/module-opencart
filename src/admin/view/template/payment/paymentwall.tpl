            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-paymentwall" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="paymentwall_key" value="<?php echo $paymentwall_key; ?>" id="paymentwall_key"/>
                            <?php if ($error_key) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="paymentwall_secret" value="<?php echo $paymentwall_secret; ?>" id="paymentwall_secret"/>
                            <?php if ($error_secret) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="paymentwall_widget" value="<?php echo $paymentwall_widget; ?>" id="paymentwall_widget"/>
                            <?php if ($error_widget) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="paymentwall_complete_status" id="paymentwall_complete_status">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="paymentwall_cancel_status" id="paymentwall_cancel_status">
                                <?php foreach($statuses as $key => $value) { ?>
                                <option value="<?php echo $key; ?>"
